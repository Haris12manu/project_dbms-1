...
<div class="topnav-right">
  ...
  <a href="login.php">About</a>
   ...
   <center> 
       ...
       <div class="row">
        <?php
                try{
                    ...
                    where star_brane_id='18' order by star_id desc limit 8 ");
    ...
    <img class="card-img-top" src="../admin/product_tb/img/<?php echo $row_select['star_img']; ?>" alt="Card image" style="width=350"height="160px">
    <div class="card-body">
      ...
      <a href="nasohop1.php">ดูเพิ่มเติม</a>
    </div>
   </div>
   </div>
