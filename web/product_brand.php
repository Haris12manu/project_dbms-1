...
<div class="topnav-right">
  ...
  <a href="login.php">About</a>
   ...
   <center> 
    ...
    <img class="card-img-top" src="../admin/product_tb/img/<?php echo $row_select['star_img']; ?>" alt="Card image" style="width=300%">
    <div class="card-body">
      ...
      <a href="shop_product.php?id=<?php echo $row_select['star_id']; ?>" class="btn btn-primary">สั่งสินค้า</a><br>
      <a href="shop_product.php?id=<?php echo $row_select['star_id']; ?>">ดูเพิ่มเติม</a>
    </div>
   </div>
   </div>
